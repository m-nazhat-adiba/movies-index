...
>
  <div
    class="d-flex flex-row align-items-center justify-content-center pb-3"
  >
    <i class="bi bi-play-circle" style="font-size: 2rem"></i>
    <p class="card-text fs-5 ps-2">2:26</p>
  </div>
</div>
<a class="card-img-overlay"></a>
<h4 class="card-title fs-5 text-white"></h4>
<p class="card-text fs-6 text-white"></p>
</div>
`;
...
class videoCard extends HTMLElement {
  constructor() {
    ...
    this.shadowRoot.querySelector(".len").href =
      this.getAttribute("targetLink");
  }
